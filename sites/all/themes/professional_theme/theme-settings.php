...
function professional_theme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['prof_settings']['slideshow']['slideshow_display'] = array(
   ...
   $form['prof_settings']['slideshow']['slideshow_all'] = array(
    '#type' => 'checkbox',
    '#title' => t('Show slideshow on every page'),
    '#default_value' => theme_get_setting('slideshow_all','professional_theme'),
    '#description'   => t("Check this option to show Slideshow on every page. Uncheck to hide."),
  );
  ...
  $form['prof_settings']['slideshow']['slide1']['slide1_image_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Image URL'),
    '#default_value' => theme_get_setting('slide1_image_url','professional_theme'),  
  );
 ...
 $form['prof_settings']['slideshow']['slide1']['slide_alt'] = array(
  ...
  $form['prof_settings']['slideshow']['slide2']['slide2_image_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Image URL'),
    '#default_value' => theme_get_setting('slide2_image_url','professional_theme'),  
  );
 ...
 $form['prof_settings']['slideshow']['slide2']['slide2_alt'] = array(
  ...
  $form['prof_settings']['slideshow']['slide3']['slide3_image_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Image URL'),
    '#default_value' => theme_get_setting('slide3_image_url','professional_theme'),  
